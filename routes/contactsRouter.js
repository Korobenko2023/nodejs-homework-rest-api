...
const { getAllContacts, getOneContact, deleteContact, createContact, updateContact } = require("../controllers/contact/contactsControllers");
...
contactsRouter.patch("/favorite/:id", authenticate, isValidId, validateBody(updateStatusContactSchema), updateContact);
